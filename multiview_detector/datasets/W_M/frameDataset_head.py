...
class frameDataset(VisionDataset):
    # 为了和citystreet训练难度匹配，将这里训练集所占比重降低至0.6,ji
    ...
    def __getitem__(self, index):
        ...
        imgs_gt = []
        for cam in range(self.num_cam):
            img_gt_head = self.imgs_head_foot_gt[frame][cam]
            ...
            if self.target_transform is not None:
                img_gt_head = self.target_transform(img_gt_head) * self.facofgt
