...
from multiview_detector.datasets.CityStreet.framedataset_depthmap_detect import frameDataset_depth_map_full_size
from multiview_detector.models.CityStreet.Perspective_depthmap_2D_SVP_VCW import DPerspTransDetector
from multiview_detector.trainer.CityStreet.trainer_depthmap_2D_SVP_VCW import PerspectiveTrainer
...
def model_run(args):
    ...
    # 初始化weight
    initial_weight = torch.full((3, 1, 384, 320), 1 / 3)
    model = DPerspTransDetector(train_set, initial_weight, arch=args.arch, fix_2D=args.fix_2D,
                                fix_svp=args.fix_svp, fix_weight=args.fix_weight, person_heights=args.person_heights).cuda()
    ...
    if 'resnet' in args.arch:
        optimizer1 = optim.SGD([{'params': model.base_pt1.parameters(), 'lr': args.lr},
                                ...
                                {'params': model.weight_consistency.parameters(), 'lr': args.lr},
    ...
    if args.resume is None:
        ...
        shutil.copy(
            '/home/yunfei/Study/MVD_VCW/multiview_detector/models/CityStreet/Perspective_depthmap_2D_SVP_VCW.py',
            logdir + '/scripts/Perspective_depthmap_2D_SVP_VCW.py')
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/trainer/CityStreet/trainer_depthmap_2D_SVP_VCW.py',
                    logdir + '/scripts/trainer_2D_SVP_VCW.py')
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/x_training/CityStreet/model_run_2D_SVP_VCW.py',
                    logdir + '/scripts/model_run_2D_SVP_VCW.py')
    ...
    if args.resume is None:
        ...
        if args.arch == 'resnet18':
            ...
            # pretrained_model_dir = '/home/yunfei/Study/MVD_VCW/logs/citystreet_frame/vgg16/2D_SVP_VCW' \
            #                        '/2023-06-26_10-17-36heights[1750]_fix2D1.0w1_fixsvp0.0w1_fixconf0.0_momentum0.9_weight_decay0.0001_lr0.01_' \
            #                        'lrsonecycle_epo200_ct0.4_nt10_dt20/MultiviewDetector.pth'
        ...
        #              weight_mask=torch.ones(3, 1, 384, 320))
        # trainer.test(test_loader, train_set.gt_fpath, True, epoch_dir, first_test=True)
        print('\n')
        for epoch in tqdm.tqdm(range(1, args.epochs + 1)):
            train_loss= trainer.train(train_loader, epoch, optimizer, args.log_interval, scheduler)
