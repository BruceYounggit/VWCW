...
from multiview_detector.models.CityStreet.Perspective_depthmap_2D_SVP_VCW_Multi_height_MVDet import DPerspTransDetector as MVDet
from multiview_detector.models.CityStreet.Perspective_depthmap_2D_SVP_VCW_Multi_height_3DROM import DPerspTransDetector as TDROM
# Pespective_Trainer
from multiview_detector.trainer.CityStreet.trainer_depthmap_2D_SVP_VCW_Multi_height_MVDet import PerspectiveTrainer
...
def model_run(args):
    ...
    test_loader = torch.utils.data.DataLoader(test_set, batch_size=args.batch_size, shuffle=False,
                                              num_workers=args.num_workers, pin_memory=True)
    # Note that the coefficient "fix_conf", which is used for fix the MLP of learning weight from depth map.
    if args.multiheight=='mvdet':
        model = MVDet(train_set, arch=args.arch, fix_2D=args.fix_2D,
                                    fix_svp=args.fix_svp, fix_conf=args.fix_conf, person_heights=args.person_heights)
    ...
    logdir = f'logs/{args.dataset}_frame/{args.arch}/{args.variant}/' + datetime.datetime.today().strftime(
        '%Y-%m-%d_%H-%M-%S') + f'heights{args.person_heights}_fix2D{args.fix_2D}w{args.weight_2D}_fixsvp{args.fix_svp}w{args.weight_svp}_fixconf{args.fix_conf}_' \
    ...
    if args.resume is None:
        ...
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/models/CityStreet/'
                    ...
                    logdir + '/scripts/Perspective_depthmap_2D_SVP_VCW_Multi_height_MVDet.py')
        shutil.copy(
            '/home/yunfei/Study/MVD_VCW/multiview_detector/trainer/CityStreet/trainer_depthmap_2D_SVP_VCW_Multi_height_MVDet.py',
            logdir + '/scripts/trainer_depthmap_2D_SVP_VCW_Multi_height_MVDet.py')
        shutil.copy(
            '/home/yunfei/Study/MVD_VCW/multiview_detector/x_training/CityStreet/model_run_2D_SVP_VCW_Multi_height_MVDet.py',
            logdir + '/scripts/model_run_2D_SVP_VCW_Multi_height_MVDet.py')
    ...
    trainer = PerspectiveTrainer(model, logdir, denormalize, args.cls_thres * train_set.facofmaxgt_gp, args.nms_thres,
                                 ...
                                 fix_2D=args.fix_2D, fix_svp=args.fix_svp, fix_conf=args.fix_conf)
    # learn
    ...
    if args.resume is None:
        ...
        if args.arch == 'resnet18':
            ...
            #                        '/2D_SVP_3D/2022-11-17_09-56-39/MultiviewDetector_100.pth'
            ...
            # pretrained_model_dir = '/home/yunfei/Study/Baseline_MVDet/logs/citystreet_frame/2D/2022-11-10_00-21-45/MultiviewDetector_50.pth'
