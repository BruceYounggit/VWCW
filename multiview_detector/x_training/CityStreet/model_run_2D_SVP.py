...
from multiview_detector.models.CityStreet.Perspective_depthmap_2D_SVP import DPerspTransDetector
...
def model_run(args):
    ...
    if args.resume is None:
        ...
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/models/CityStreet/Perspective_depthmap_2D_SVP.py',
                    logdir + '/scripts/Perspective_depthmap_2D_SVP.py')
        ...
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/x_training/CityStreet/model_run_2D_SVP.py',
    ...
    if args.resume is None:
        ...
        if 'resnet' in args.arch:
            ...
            pretrained_model_dir = '/home/yunfei/Study/MVD_VCW/logs/citystreet_frame/vgg16/2D_SVP/2023-04-24_1' \
                                   '9-12-45_fix2D1.0w1_fixsvp0.0w1_momentum0.9_weight_decay0.0001_lr0.01' \
                                   '_lrsonecycle_epo100_ct0.4_nt10_dt20/MultiviewDetector_100.pth'
