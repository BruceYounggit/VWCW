...
# from multiview_detector.models.CityStreet.Perspective_depthmap_2D_SVP_VCW_Mu import DPerspTransDetector
from multiview_detector.models.CityStreet.Perspective_depthmap_2D_SVP_VCW_Multi_height_MVDet import DPerspTransDetector
from multiview_detector.trainer.CityStreet.trainer_depthmap_2D_SVP import PerspectiveTrainer
...
def model_run(args):
    ...
    # logging
    logdir = f'logs/{args.dataset}_frame/{args.arch}/{args.variant}/{args.person_heights}/' + datetime.datetime.today().strftime(
    ...
    if args.resume is None:
        ...
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/models/CityStreet/Perspective_depthmap_2D_SVP_VCW_Multi_height_MVDet.py',
                    logdir + '/scripts/Perspective_depthmap_2D_SVP_VCW_Multi_height_MVDet.py')
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/trainer/CityStreet/trainer_depthmap_2D_SVP.py',
                    logdir + '/scripts/trainer_2D_SVP.py')
        shutil.copy('/home/yunfei/Study/MVD_VCW/multiview_detector/x_training/CityStreet/model_run_2D_SVP_VCW_Multi_height.py',
    ...
    if args.resume is None:
        ...
        if 'resnet' in args.arch:
            pretrained_model_dir = '/home/yunfei/Study/MVD_VCW/logs/citystreet_frame/resnet18/2D/2023-04-23_13-00-06_fix2D0.0w1_fixsvp0w1' \
                                   '_momentum0.9_weight_decay0.0001_lr0.0001_lrslambda_epo5' \
                                   '0_ct0.4_nt20_dt20/MultiviewDetector.pth'
        else:
            # pretrained_model_dir = '/home/yunfei/Study/Baseline_MVDet/logs/citystreet_frame/2D/' \
            #                        '2022-11-10_00-21-45/MultiviewDetector_50.pth'
